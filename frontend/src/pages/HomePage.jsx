...
import { ArrowRightIcon, Check, CheckIcon, Code2Icon, SparklesIcon, UsersIcon, VideoIcon, ZapIcon } from "lucide-react";
...
function HomePage(){
    ...
    <div className ="bg-gradient-to-br from-base-100 via-base-200 to-base-300">
        ...
        <div className ="max-w-7xl mx-auto p-4 flex items-center justify-between">
            {/*LOGO*/}
            <Link to={"/"}
            className ="flex items-center gap-3 hover:scale-105 transitio-transform duration-200" >
  ...
  <div className ="max-w-7xl mx-auto px-4 py-20">
    <div className ="grid lg:grid-cols-2 gap-12 items-center">
        ...
        <div className ="space-y-8">
            <div className ="badge badge-primary badge-lg bg-accent ">
